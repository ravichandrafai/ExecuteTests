...
public class UploadFiles extends BasePage{
	...
	public UploadFiles browseFiles(String fileName) throws AWTException, InterruptedException {
	...
	public String getUploadedFileName(String matterID) throws InterruptedException {
		//Thread.sleep(2000);
		...
		if(uplaodedFiles.size()>=1)
			for(WebElement fileName:uplaodedFiles) {
				String[] onlyName = fileName.getText().split(",");
