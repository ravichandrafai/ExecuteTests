...
public class WorkList extends BasePage {
	...
	public WorkList waitForFilestatusChange(String files,String expectedFileStaus) throws AWTException {
	...
	public WorkList mergeFiles() {
		...
		ExplicitWaitConditions.performExplicitWait(alert, ExplicitWaitExpextecConditions.VISIBILE);
